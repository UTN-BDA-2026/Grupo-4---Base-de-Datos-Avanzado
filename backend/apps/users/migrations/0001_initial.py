...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-played_at'],
                'indexes': [models.Index(fields=['user'], name='users_liste_user_id_f5a77e_idx'), models.Index(fields=['song'], name='users_liste_song_id_678e9b_idx'), models.Index(fields=['played_at'], name='users_liste_played__16c1f6_idx'), models.Index(fields=['user', 'played_at'], name='users_liste_user_id_09d238_idx'), models.Index(fields=['song', 'user'], name='users_liste_song_id_4cc726_idx')],
            },
        ),
        migrations.CreateModel(
            name='UserLibrary',
